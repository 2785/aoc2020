...
import (
	...
	"github.com/2785/aoc2020/pkg/d18"
	"github.com/2785/aoc2020/pkg/d19"
	"github.com/2785/aoc2020/pkg/d2"
	"github.com/2785/aoc2020/pkg/d20"
	"github.com/2785/aoc2020/pkg/d21"
	"github.com/2785/aoc2020/pkg/d22"
	"github.com/2785/aoc2020/pkg/d23"
	"github.com/2785/aoc2020/pkg/d24"
	"github.com/2785/aoc2020/pkg/d25"
...
var d18Cmd = &cobra.Command{
	Use:   "d18",
	Short: "Run solution for day 18",
	RunE: func(cmd *cobra.Command, args []string) error {
		fmt.Printf("running day 18 puzzle with input file %s\n", inputFile)
		...
		parsed := d18.ParseInput(f)

		part1, err := d18.SolvePart1(parsed)
		...
		part2, err := d18.SolvePart2(parsed)
...
var d19Cmd = &cobra.Command{
	Use:   "d19",
	Short: "Run solution for day 19",
	RunE: func(cmd *cobra.Command, args []string) error {
		fmt.Printf("running day 19 puzzle with input file %s\n", inputFile)
		...
		rule, input, err := d19.ParseInput(f)

		if err != nil {
			return fmt.Errorf("cannot parse input: %w", err)
		}

		part1, err := d19.SolvePart1(rule, input)
		...
		part2, err := d19.SolvePart2(rule, input)
...
var d20Cmd = &cobra.Command{
	Use:   "d20",
	Short: "Run solution for day 20",
	RunE: func(cmd *cobra.Command, args []string) error {
		fmt.Printf("running day 20 puzzle with input file %s\n", inputFile)
		...
		parsed, err := d20.ParseInput(f)

		if err != nil {
			return fmt.Errorf("error parsing input: %w", err)
		}

		part1, err := d20.SolvePart1(parsed)
		...
		part2, err := d20.SolvePart2(parsed)
...
var d21Cmd = &cobra.Command{
	Use:   "d21",
	Short: "Run solution for day 21",
	RunE: func(cmd *cobra.Command, args []string) error {
		fmt.Printf("running day 21 puzzle with input file %s\n", inputFile)
		...
		parsed, err := d21.ParseInput(f)

		if err != nil {
			return fmt.Errorf("error parsing input: %w", err)
		}

		part1, err := d21.SolvePart1(parsed)
		...
		part2, err := d21.SolvePart2(parsed)
...
var d22Cmd = &cobra.Command{
	Use:   "d22",
	Short: "Run solution for day 22",
	RunE: func(cmd *cobra.Command, args []string) error {
		fmt.Printf("running day 22 puzzle with input file %s\n", inputFile)
		...
		p1, p2, err := d22.ParseInput(f)

		if err != nil {
			return fmt.Errorf("error parsing input: %w", err)
		}

		part1 := d22.SolvePart1(p1, p2)

		fmt.Printf("Part 1 solution: %v\n", part1)

		part2, err := d22.SolvePart2(p1, p2)
...
var d23Cmd = &cobra.Command{
	Use:   "d23",
	Short: "Run solution for day 23",
	RunE: func(cmd *cobra.Command, args []string) error {
		fmt.Printf("running day 23 puzzle with input file %s\n", inputFile)
		...
		p, err := d23.ParseInput(f)

		if err != nil {
			return fmt.Errorf("error parsing input: %w", err)
		}

		part1 := d23.SolvePart1(p)

		fmt.Printf("Part 1 solution: %v\n", part1)

		part2 := d23.SolvePart2(p)
...
var d24Cmd = &cobra.Command{
	Use:   "d24",
	Short: "Run solution for day 24",
	RunE: func(cmd *cobra.Command, args []string) error {
		fmt.Printf("running day 24 puzzle with input file %s\n", inputFile)
		...
		p, err := d24.ParseInput(f)

		if err != nil {
			return fmt.Errorf("error parsing input: %w", err)
		}

		part1 := d24.SolvePart1(p)

		fmt.Printf("Part 1 solution: %v\n", part1)

		part2 := d24.SolvePart2(p)
...
var d25Cmd = &cobra.Command{
	Use:   "d25",
	Short: "Run solution for day 25",
	RunE: func(cmd *cobra.Command, args []string) error {
		fmt.Printf("running day 25 puzzle with input file %s\n", inputFile)
		...
		n1, n2, err := d25.ParseInput(f)

		if err != nil {
			return fmt.Errorf("error parsing input: %w", err)
		}

		part1, err := d25.SolvePart1(n1, n2)
...
func init() {
	...
	d18Cmd.Flags().StringVarP(&inputFile, "input", "i", "inputs/d18", "input file path")
	rootCmd.AddCommand(d18Cmd)

	d19Cmd.Flags().StringVarP(&inputFile, "input", "i", "inputs/d19", "input file path")
	rootCmd.AddCommand(d19Cmd)

	d20Cmd.Flags().StringVarP(&inputFile, "input", "i", "inputs/d20", "input file path")
	rootCmd.AddCommand(d20Cmd)

	d21Cmd.Flags().StringVarP(&inputFile, "input", "i", "inputs/d21", "input file path")
	rootCmd.AddCommand(d21Cmd)

	d22Cmd.Flags().StringVarP(&inputFile, "input", "i", "inputs/d22", "input file path")
	rootCmd.AddCommand(d22Cmd)

	d23Cmd.Flags().StringVarP(&inputFile, "input", "i", "inputs/d23", "input file path")
	rootCmd.AddCommand(d23Cmd)

	d24Cmd.Flags().StringVarP(&inputFile, "input", "i", "inputs/d24", "input file path")
	rootCmd.AddCommand(d24Cmd)

	d25Cmd.Flags().StringVarP(&inputFile, "input", "i", "inputs/d25", "input file path")
	rootCmd.AddCommand(d25Cmd)
